...
public class HpassDriverWithRegistryTest extends BaseIntegrationTest {
  ...
  void FailedCheckIfIdentifierIsWellFormed() {
    ...
    String expected = messageUtils.formatMessage("IDENTIFIER_IS_INVALID", id);
  ...
  void FailedRetrieveNetworkServers() {
    ...
    String expected = messageUtils.formatMessage("COULD_NOT_RETRIEVE_SERVERS_FROM_REGISTRY_FOR_IDENTIFIER", id, "");
  ...
  void FailedRetrieveBodyAsJsonObject() {
    ...
    String id = "did:hpass:bbbb172ac3622332beacdd2089ddd20a82ae90c32b4b81515237245c9683e6dd:f176010ec01d4eaf04ac49c54b568358e4a17a0d4e5a0f8eb7cfe17797d6bbbb";
    String expected = messageUtils.formatMessage("COULD_NOT_EXTRACT_JSON_OBJECT_FROM_HTTP_RESPONSE", "");
  ...
  void FailedRetrieveValidJsonResponseEmpty() {
    ...
    String id = "did:hpass:bbbb172ac3622332beacdd2089ddd20a82ae90c32b4b81515237245c9683e6dd:f176010ec01d4eaf04ac49c54b568358e4a17a0d4e5a0f8eb7cfe17797d6bbbb";
    String expected = messageUtils.formatMessage("COULD_NOT_RETRIEVE_VALID_JSON_RESPONSE_FROM_BLOCKCHAIN_NETWORK", id);
  ...
  void FailedRetrieveURLFromValidJsonResponse() {
    ...
    String id = "did:hpass:bbbb172ac3622332beacdd2089ddd20a82ae90c32b4b81515237245c9683e6dd:f176010ec01d4eaf04ac49c54b568358e4a17a0d4e5a0f8eb7cfe17797d6bbbb";
    String expected = messageUtils.formatMessage("COULD_NOT_RESOLVE_DID_NETWORK_URL_FROM_REGISTRY_RESPONSE", body);
  ...
  void FailedFetchDidFromBlockchainNetworkMethodSet() {
    ...
    String id = "did:hpass:bbbb172ac3622332beacdd2089ddd20a82ae90c32b4b81515237245c9683e6dd:f176010ec01d4eaf04ac49c54b568358e4a17a0d4e5a0f8eb7cfe17797d6bbbb";
    String expected = messageUtils.formatMessage("NO_VALID_HTTP_METHOD_FOUND_IN_REGISTRY_FOR_URL", "");
    expected = expected.substring(0, expected.lastIndexOf(":"));
  ...
  void FailedFetchDidFromNetwork() {
    ...
    String id = "did:hpass:bbbb172ac3622332beacdd2089ddd20a82ae90c32b4b81515237245c9683e6dd:f176010ec01d4eaf04ac49c54b568358e4a17a0d4e5a0f8eb7cfe17797d6bbbb";
    String expected = messageUtils.formatMessage("COULD_NOT_FETCH_DID_FROM_NETWORK_FOR_IDENTIFIER", "", statusCodeHpass);
  ...
  void FailedGetDidPayload() {
    ...
    String id = "did:hpass:bbbb172ac3622332beacdd2089ddd20a82ae90c32b4b81515237245c9683e6dd:f176010ec01d4eaf04ac49c54b568358e4a17a0d4e5a0f8eb7cfe17797d6bbbb";
    String expected = messageUtils.formatMessage("DID_PAYLOAD_NOT_FOUND");
  ...
  void FailedGetVerificationMethodsMandatoryKeyNotFound() {
    ...
    String id = "did:hpass:bbbb172ac3622332beacdd2089ddd20a82ae90c32b4b81515237245c9683e6dd:f176010ec01d4eaf04ac49c54b568358e4a17a0d4e5a0f8eb7cfe17797d6bbbb";
    String expected = messageUtils.formatMessage("MANDATORY_KEY_NOT_FOUND", "");
    expected = expected.substring(0, expected.lastIndexOf(":"));
